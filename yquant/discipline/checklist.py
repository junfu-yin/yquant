...
Five mandatory items must all be satisfied before a proposal can be marked
...
class ExecutionChecklist:
    """The five §5.5 checklist items and their state.
    ...
    def unmet_items(self) -> list[str]:
        ...
        if not self.within_single_name_cap:
            unmet.append("within_single_name_cap")
